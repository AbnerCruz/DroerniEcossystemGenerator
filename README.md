...
patchnotes-v36.md        changelog da versão atual (um .md por versão)
```

> Ao subir uma versão nova, lembre de bumpar `VERSAO` em `sw.js` (hoje
> `drn2-v36`) e de acrescentar o `patchnotes-vXX.md` novo à lista de arquivos
